class Node:
    ...
    def get_next(self):
        return (
            self.__next
        )  #############DOES THIS GIVE NEXT NODE OR ADDRESS OF THE NEXT NODE####################
...
class LinkedList:
    ...
    def add(self, data):
        ...
        if self.__head is None:
            ...
            self.__head = (
                self.__tail
            ) = new_node  # for linked list with only one node, head and tail node will be same
        else:
    ...
    def insert(self, data, data_before):
        ...
        if data_before == None:  # if we want to insert a new element just before head
            ...
            if node_before is not None:
                new_node.set_next(
                    node_before.get_next()
                )  # check the notes for clarification
